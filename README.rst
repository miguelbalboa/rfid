...
+-----------+---------------+--------------------------+-----------+
|           | ESP8266       | Teensy                   | Seeeduino |
|           +---------------+--------+--------+--------+-----------+
|           | Wemos D1 mini | 2.0    | ++ 2.0 | 3.1    | XIAO      |
+-----------+---------------+--------+--------+--------+-----------+
| Signal    | Pin           | Pin    | Pin    | Pin    | Pin       |
+===========+===============+========+========+========+===========+
| RST/Reset | D3            | 7      | 4      | 9      | 5 [1]_    |
+-----------+---------------+--------+--------+--------+-----------+
| SPI SS    | D8            | 0      | 20     | 10     | 4 [2]_    |
+-----------+---------------+--------+--------+--------+-----------+
| SPI MOSI  | D7            | 2      | 22     | 11     | 10        |
+-----------+---------------+--------+--------+--------+-----------+
| SPI MISO  | D6            | 3      | 23     | 12     | 9         |
+-----------+---------------+--------+--------+--------+-----------+
| SPI SCK   | D5            | 1      | 21     | 13     | 8         |
+-----------+---------------+--------+--------+--------+-----------+
